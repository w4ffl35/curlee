...
//
// NOTE: This file is a STALE SNAPSHOT and is NOT compiled. The live emitter
// implementation lives in src/compiler/emitter.cpp (which the build compiles).
// Do not edit this file; edits belong in emitter.cpp. It is retained only as a
