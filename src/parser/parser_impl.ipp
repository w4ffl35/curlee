...
//
// NOTE: This file is a STALE SNAPSHOT and is NOT compiled. The live parser
// implementation lives in src/parser/parser.cpp (which the build compiles).
// Do not edit this file; edits belong in parser.cpp. It is retained only as a
// historical artifact and will be removed once all references are gone.
#include <cassert>
#include <cstddef>
