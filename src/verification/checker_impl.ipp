...
//
// NOTE: This file is a STALE SNAPSHOT and is NOT compiled. The live verifier
// implementation lives in src/verification/checker.cpp (which the build
// compiles). Do not edit this file; edits belong in checker.cpp. It is
