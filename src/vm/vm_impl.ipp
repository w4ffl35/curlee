...
//
// NOTE: This file is a STALE SNAPSHOT and is NOT compiled. The live VM
// implementation lives in src/vm/vm.cpp (which the build compiles).
// Do not edit this file; edits belong in vm.cpp. It is retained only as a
