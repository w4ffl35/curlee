...
//
// NOTE: This file is a STALE SNAPSHOT and is NOT compiled. The live type
// checker implementation lives in src/types/type_check.cpp (which the build
// compiles). Do not edit this file; edits belong in type_check.cpp. It is
// retained only as a historical artifact and will be removed once all
// references are gone.
#include <cassert>
